...
@Component({
  selector: 'app-comment-single-post',
  templateUrl: './comment-single-post.component.html',
  styleUrls: ['./comment-single-post.component.scss'],
})
export class CommentSinglePostComponent implements OnInit {
