...
@Component({
  selector: 'app-comment-tag-post',
  templateUrl: './comment-tag-post.component.html',
  styleUrls: ['./comment-tag-post.component.scss'],
})
export class CommentTagPostComponent implements OnInit {
